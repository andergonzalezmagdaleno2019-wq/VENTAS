<div class="container is-fluid mb-6">
	...
	<h2 class="subtitle"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; Lista y Búsqueda de cajas</h2>
</div>
<div class="container pb-6 pt-6">
    <?php
        if($_SESSION['rol'] != 1){
            echo '<div class="notification is-danger is-light has-text-centered"><h4 class="title is-4">¡Acceso Denegado!</h4><p>No tienes los permisos necesarios.</p></div>';
        } else { 
		    $insCaja = new app\controllers\cashierController();
        ...
        <div class="column">
            <form class="FormularioAjax" action="<?php echo APP_URL; ?>app/ajax/buscadorAjax.php" method="POST" autocomplete="off" >
                ...
                <div class="field is-grouped">
                    <p class="control is-expanded"><input class="input is-rounded" type="text" name="txt_buscador" placeholder="¿Qué estas buscando?" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,30}" maxlength="30" ></p>
	...
	<?php
		    ...
		    echo $insCaja->listarCajaControlador($pagina_actual, 15, $url[0], $busqueda);
        } 
    ?>
</div>