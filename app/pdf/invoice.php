<?php
	...
	if($datos_venta->rowCount()==1){
		...
		$pdf->Cell(150,7,iconv("UTF-8", "ISO-8859-1//TRANSLIT","RIF: ".$emp_rif),0,1,'L');
		$pdf->Cell(150,5,iconv("UTF-8", "ISO-8859-1//TRANSLIT","Teléfono: ".$emp_tel_format),0,1,'L');
        ...
        $base_imponible_bs = $total_general_bs / 1.16; 
        $iva_16_bs = $total_general_bs - $base_imponible_bs; 
