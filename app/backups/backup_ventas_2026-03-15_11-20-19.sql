...
INSERT INTO caja VALUES ("1","1","Caja Principal","960.00");
...
INSERT INTO rol VALUES ("1","Administrador"), ("2","Vendedor"), ("3","Supervisor");
...
("1","Computación","","",""), ("2","Laptops","1","",""), ("3","Monitores","1","",""), ("4","All in one","1","",""), 
("6","PC de escritorio","1","",""), ("7","Impresión y oficina","","",""), ("8","Consumibles","7","",""), 
("9","Componentes de PC","","",""), ("10","Unidades de almacenamiento","9","",""), ("11","Gabinetes","9","",""), 
("12","Periféricos","","",""), ("13","Audífonos","12","","");
...
INSERT INTO cliente VALUES ("1","Otro","N/A","Publico","General","N/A","N/A","N/A","N/A","N/A");
...
INSERT INTO proveedor VALUES ("1","Conputodo","71281237-2","2236789","");
...
INSERT INTO empresa VALUES ("1","Fasnet Lideres en Tecnología","J-29665886-2","04127465438","Fasnet.comunicaciones@gmail.com","Av. Anthons Phillips cc Av Merida local galpon Nro Sn Zona Industrial La Hamaca");

-- 2. TABLA USUARIO (Depende de caja y rol)
...
-- 3. TABLAS QUE DEPENDEN DE USUARIO (BITÁCORA, PRODUCTO, COMPRA, VENTA)
...
INSERT INTO producto VALUES ("1","2498217649872","Laptop gamer","0","","0.00","0.00","HP","I9 9700k","Activo","","2","800.00","5","100","960.00","8","Unidad","1");
...
INSERT INTO compra_detalle VALUES ("1","1","1","1","700.00"), ("2","2","1","1","800.00"), ("3","3","1","1","800.00"), ("4","4","1","1","800.00");

CREATE TABLE `compra_pagos` (
  `pago_id` int(11) NOT NULL AUTO_INCREMENT,
  `compra_id` int(11) NOT NULL,
  `usuario_id` int(7) NOT NULL, -- Ajustado a int(7) para coincidir con usuario_id
...
("1","1","1","2026-03-15","100.00","Efectivo","EFECTIVO/DIVISA",""), ("2","1","1","2026-03-15","600.00","Efectivo","EFECTIVO/DIVISA",""), 
("3","2","1","2026-03-15","800.00","Efectivo","EFECTIVO/DIVISA",""), ("4","4","1","2026-03-15","900.00","Anticipo","Pago al ordenar",""), 
...
INSERT INTO venta VALUES ("1","VEN-000001","2026-03-15","10:57 am","960.00","960.00","0.00","446.80","1","1","1","Efectivo","");
...
INSERT INTO venta_detalle VALUES ("1","1","800.00","960.00","960.00","Laptop gamer","VEN-000001","1");
...
("1","1","1","2026-03-15",""), ("2","2","1","2026-03-15","Se subio el precio"), 
("3","3","1","2026-03-15",""), ("4","4","1","2026-03-15","");

CREATE TABLE `recepcion_detalle` (
  `recepcion_detalle_id` int(11) NOT NULL AUTO_INCREMENT,
  `recepcion_id` int(11) NOT NULL,
  `producto_id` int(20) NOT NULL, -- Ajustado a int(20) para coincidir con producto_id
...
INSERT INTO recepcion_detalle VALUES ("1","1","1","1"), ("2","2","1","1"), ("3","3","1","1"), ("4","4","1","1");